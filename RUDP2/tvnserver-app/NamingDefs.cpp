...
const TCHAR ProductNames::SERVER_PRODUCT_NAME[] = _T("Telework System Server for LGWAN Usermode");

const TCHAR RegistryPaths::SERVER_PATH[] = _T("Software\\Telework System for LGWAN\\URDP2\\Server");
const TCHAR RegistryPaths::SERVER_REVERSE_CONN_HISTORY_PATH[] =
  _T("Software\\Telework System for LGWAN\\URDP2\\Control\\ReverseConnectionHistory");
const TCHAR RegistryPaths::DISPATCHER_CONN_HISTORY_PATH[] =
  _T("Software\\Telework System for LGWAN\\URDP2\\Control\\DispatcherConnectionHistory");
...
const TCHAR ServiceNames::SERVICE_NAME_TO_DISPLAY[] = _T("Telework System for LGWAN RUDP2");
